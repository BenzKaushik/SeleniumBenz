...
public class Utils {
	...
	/*
	 * public void FailScreenshot(String stepName) { try { Date d = new Date();
	 * String newDateformat = d.toString().replace(" ", "_").replace(":", "_");
	 ...
	 * permanentFile = new File(System.getProperty("user.dir")+
	 * "\\FailedScreenshot\\"+stepName+"_"+newDateformat+".png"); //Copy from
	 * temporary location to permanent location FileUtils.copyFile(tempFile,
	 * permanentFile); } catch (IOException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } }
	 */
	...
	//Function for failed screenshot - changed for Extent Report
		public  String FailScreenshot(String stepName) {
			try {
				...
				File tempFile = scr.getScreenshotAs(OutputType.FILE);
				//Location path
				String path = System.getProperty("user.dir")+"\\FailedScreenshot\\"+stepName+"_"+newDateformat+".png";
				//Permanent location address
