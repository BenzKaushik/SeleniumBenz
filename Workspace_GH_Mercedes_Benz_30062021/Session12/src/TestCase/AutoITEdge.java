...
public class AutoITEdge extends BaseSettings{
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		driver = AutoITChrome.RunBrowser("Edge");
		...
		Runtime.getRuntime().exec("C:\\Users\\lenovo\\Desktop\\GH_Mercedes benz\\AutoITScript\\EdgeScript.exe");
