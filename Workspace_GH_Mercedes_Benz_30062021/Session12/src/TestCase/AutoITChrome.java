...
public class AutoITChrome extends BaseSettings{
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver = AutoITChrome.RunBrowser("Chrome");
		...
		Runtime.getRuntime().exec("C:\\Users\\lenovo\\Desktop\\GH_Mercedes benz\\AutoITScript\\ChromeScript.exe");
