...
public class AutoITFirefox extends BaseSettings{
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		driver = AutoITFirefox.RunBrowser("Firefox");
		...
		//driver.findElement(By.xpath("//*[@id='fileToUpload']")).click();
		...
		Runtime.getRuntime().exec("C:\\Users\\lenovo\\Desktop\\GH_Mercedes benz\\AutoITScript\\FirefoxScript.exe");
