...
public class formRediffmail extends BaseSettings{
	...
	public  void FillingFormRediffmail(Hashtable <String, String> h) throws InterruptedException {
		...
		u.navigateURL("https://register.rediff.com/register/register.php?FormName=user_details");
		...
		//u.explicitWaitText("className", "f22", "Create a Rediffmail account");
		u.explicitWaitText("className", "waitTextCreateARediffmailAccount_className_landingPage", "Create a Rediffmail account");
		...
		u.explicitWaitText("className", "verifyTextCreateARediffmailAccount_className_landingPage", "Create a Rediffmail account");
		...
		u.AssertText("Create a Rediffmail account", "xpath", "assertTextCreateARediffmailAccount_xpath_landingPage", "for the text Create a Rediffmail account");	
		...
		u.AssertText("Full Name", "xpath", "assertTextFullName_xpath_fullNameEditBox", "for the text Full Name");
		...
		//u.typeEditBox("xpath", "//*[@id='tblcrtac']/tbody/tr[3]/td[3]/input", h.get("FName"));
		u.typeEditBox("xpath", "typeFullName_xpath_fullNameEditBox", h.get("FName"));
		...
		u.AssertText("Choose a Rediffmail ID", "xpath", "assertTextChooseRediffmailID_xpath_ChooseRediffmailIDEditBox", "for the text Choose a Rediffmail ID");
		...
		//u.typeEditBox("xpath", "//*[@id='tblcrtac']/tbody/tr[7]/td[3]/input[1]", h.get("RID"));
		u.typeEditBox("xpath", "typeTextChooseRediffmailID_xpath_ChooseRediffmailIDEditBox", h.get("RID"));
		...
		u.AssertAttributeValue("Check availability", "xpath", "assertAttributeValueChooseRediffmailID_xpath_checkavailabilityButton", "value attribute for check availability button", "value");
		...
		/*
		 * Actions act = new Actions(driver); wb =
		 * driver.findElement(By.xpath("//*[@id='tblcrtac']/tbody/tr[7]/td[3]/input[2]")
		 * ); act.moveToElement(wb).click(); act.build().perform();
		 */
		u.clickButtonActions("xpath", "clickCheckAvailabilityActions_xpath_checkavailabilityButton");
		...
		u.explicitWaitText("cssSelector", "explicitWait_Yippie_cssSelector", "Yippie! The ID you've chosen is available.");
		...
		if(u.VerifyTextPresent("Yippie! The ID you've chosen is available.", "xpath", "verifyTextOnCheckAvalibilityButton_xpath_CheckAvalibilityButton", "for the text Yippie! The ID you've chosen is available.")) {
			...
			u.AssertText("Yippie! The ID you've chosen is available.", "cssSelector", "assertTextYippie_cssSelector_CheckAvalibilityButton", "for the text Yippie! The ID you've chosen is available.");
			...
			u.AssertText("Password", "xpath", "assertTextPassword_xpath_PasswordEditBox", "for the text Password");
			...
			u.AssertText("Retype password", "xpath", "assertTextRetypePassword_xpath_RetypePasswordEditBox", "for the text Retype password");
			...
			//u.typeEditBox("xpath", "//*[@id='tblcrtac']/tbody/tr[11]/td[3]/input", h.get("Rpwd"));
			u.typeEditBox("xpath", "typeRetypePassword_xpath_RetypePasswordEditBox", h.get("Rpwd"));
			...
			u.AssertText(" Click if you don't have an alternate ID", "xpath", "assertTextAlternateEmailID_xpath_AlternateEmailIDCheckbox", " for the text Click if you don't have an alternate ID");
			...
			//System.out.println("Alternate Email ID checkbox is selected ? --> "+sel);
			u.isSelectedCheckBoxOrRadioButton("xpath", "isSelectedChecbox_xpath_AlternateEmailIDCheckbox", "Alternate Email ID checkbox is selected");
			...
			logger.log(Status.INFO, MarkupHelper.createLabel("To check id checkbox is SELECTED: ", ExtentColor.BLUE));
				
			
			//Now select the Checkbox
			//driver.findElement(By.xpath("//*[@id=\"tblcrtac\"]/tbody/tr[15]/td[2]/table/tbody/tr/td[1]/input")).click();
			u.selectCheckbox("xpath", "SelectedChecbox_xpath_AlternateEmailIDCheckbox");
			...
			//System.out.println("Alternate Email ID checkbox is selected ? --> "+sel1);
			u.isSelectedCheckBoxOrRadioButton("xpath", "isSelectedChecbox_xpath_AlternateEmailIDCheckbox", "Alternate Email ID checkbox is selected");
			...
			u.AssertText("Select a Security Question", "xpath", "assertTextSecurityQuestion_xpath_SecurityQuestionDropDown", " for the text Select a Security Question");
			...
			//s = new Select(wb);
			//s.selectByIndex(2);
			u.selectOptionIndex("xpath", "optionSelectSecurityQuestion_xpath_SelectSecurityQuestionDropDown", 2);
			...
			u.AssertText("Enter an Answer", "xpath", "assertTextEnterAnswer_xpath_EnterAnswerEditBox", " for the text Enter an Answer");
			...
			u.typeEditBox("xpath", "typeEnterAnswer_xpath_EnterAnswerEditBox", h.get("SQues"));
			...
			u.AssertText("Mother's Maiden Name", "xpath", "assertTextMotherName_xpath_MotherNameEditBox", " for the text Mother's Maiden Name");
			...
			//u.typeEditBox("xpath", "//*[@id='div_hintQS']/table/tbody/tr[6]/td[3]/input", h.get("MName"));
			u.typeEditBox("xpath", "typeMotherName_xpath_MotherNameEditBox", h.get("MName"));
			...
			u.AssertText("Mobile No.", "xpath", "assertTextMobileNumber_xpath_MobileNumberDropDown", " for the text Mobile No.");
			...
			u.dropDownSelection("xpath", "isdDropDownClick_xpath_isdDropDown", "isdDropDownOptionClick_xpath_isdDropDown");
			...
			u.AssertAttributeValue("mobno", "xpath", "assertAttributeValueMobileNumber_xpath_MobileNumberEditBox", "for the attribute ID", "id");
			...
			//u.typeEditBox("xpath", "//*[@id='mobno']", h.get("PNumber"));
			u.typeEditBox("xpath", "typeMobileNumber_xpath_MobileNumberEditBox", h.get("PNumber"));
			...
			u.AssertText("Date of Birth", "xpath", "assertTextDateOfBirth_xpath_DateOfBirthDropDown", " for the text Date of Birth");
			...
			//s = new Select(wb);
			//s.selectByValue("04");
			u.selectOptionValue("xpath", "selectOptionDay_xpath_DayDropDown", "04");
			...
			u.selectOptionText("xpath", "selectOptionMonth_xpath_MonthDropDown", "FEB");
			...
			//s = new Select(wb);
			//s.selectByIndex(6);
			u.selectOptionIndex("xpath", "selectOptionYear_xpath_YearDropDown", 6);
			...
			u.AssertAttributeValue("f", "xpath", "assertAttributeValue_xpath_FemaleRadioButton", "for the value attribute", "value");
			...
			u.selectRadioButton("xpath", "SelectedRadioButton_xpath_FemaleRadioButton");
			...
			u.AssertAttributeValue("country", "xpath", "assertAttributeValue_xpath_CountryDropDown", "for the attribute called class", "class");
			...
			//s = new Select(wb);
			//s.selectByValue("99");
			u.selectOptionValue("xpath", "selectOptionCountry_xpath_CountryDropDown", "99");
			...
			u.AssertText("City  ", "xpath", "assertText_xpath_CityDropDown", " for the text City");
			...
			u.selectOptionText("xpath", "selectOptionCity_xpath_CityDropDown", "Bangalore");
